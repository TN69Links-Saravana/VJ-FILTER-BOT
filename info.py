...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_ToUse")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Tn69LinksMovies')
...
URL = "https://tn69links-autofilterbot-ocj4.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tn69links-autofilterbot-ocj4.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tn69links-autofilterbot-ocj4.onrender.com/".format(FQDN)
else:
    URL = "https://tn69links-autofilterbot-ocj4.onrender.com/".format(FQDN)
